      ...
      >
        <View className="flex-row items-center gap-x-2.75 flex-1">
          ...
          <View className="flex-col items-start gap-y-0.5 flex-1 pr-2">
            <Card.Title
              className="text-h4 leading-6.75 text-brand-black dark:text-brand-white font-bold"
              numberOfLines={1}
            >
              {name}
            </Card.Title>
            <Card.Description
              className="text-[14px] leading-4.75 text-brand-black dark:text-brand-white font-sans"
              numberOfLines={1}
            >
              {email}
            </Card.Description>
