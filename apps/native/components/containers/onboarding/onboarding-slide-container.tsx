...
import OnboardingContentCard from "../../base/onboarding/onboarding-content-card";
import OnboardingNextButton from "../../base/onboarding/onboarding-next-button";
...
const OnboardingSlideContainer: FC<OnboardingSlideContainerProps> = ({
  imageSource,
  title,
  description,
  onNext,
