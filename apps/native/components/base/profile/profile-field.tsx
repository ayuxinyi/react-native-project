      ...
      <TextField>
        <InputGroup className="w-full h-14 rounded-[30px] bg-brand-flashwhite dark:bg-brand-green-500 overflow-hidden">
          <InputGroup.Input
            ...
            autoFocus
            className="flex-1 bg-transparent px-5 text-[14px] rounded-[30px] text-brand-black dark:text-brand-white font-sans"
            placeholderTextColor={isDark ? "#999" : "#888"}
          />
          <InputGroup.Suffix className="pr-4 justify-center">
            <Pressable onPress={() => setIsEditing(false)} hitSlop={8}>
              <View className="w-6 h-6 rounded-xl bg-brand-green-500 dark:bg-brand-green-800 items-center justify-center font-bold">
                <Text className="text-body-sm text-brand-white">✓</Text>
              </View>
            </Pressable>
          </InputGroup.Suffix>
        </InputGroup>
