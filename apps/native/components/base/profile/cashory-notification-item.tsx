  ...
  return (
    ...
    >
      <View className="flex-col items-start gap-y-1 flex-1 pr-6">
        <Card.Title
          className="text-base leading-4.5 text-brand-black dark:text-brand-white font-bold"
          numberOfLines={1}
        >
          {title}
        </Card.Title>
        <Card.Description
          className="text-body-xs leading-normal text-brand-black dark:text-brand-white font-sans"
          numberOfLines={2}
        >
          {description}
        </Card.Description>
